...
$GLOBALS['TL_LANG']['PSA']['meetup_join_count_short'] = 'dabei';
$GLOBALS['TL_LANG']['PSA']['meetup_decline_count_short'] = 'nicht dabei';
$GLOBALS['TL_LANG']['PSA']['meetup_join_up'] = 'Ich komme';
$GLOBALS['TL_LANG']['PSA']['meetup_join_down'] = 'Ich komme nicht';
$GLOBALS['TL_LANG']['PSA']['meetup_rsvp_label'] = 'Deine Antwort';
$GLOBALS['TL_LANG']['PSA']['meetup_joiners'] = 'Teilnehmer';
$GLOBALS['TL_LANG']['PSA']['meetup_reactions_label'] = 'Reaktionen';
