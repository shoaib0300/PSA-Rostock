...
$GLOBALS['TL_LANG'][$strName]['hero_scroll_items'] = ['Scroll items', 'Add rows with a headline and text for the scroll section below the hero.'];
$GLOBALS['TL_LANG'][$strName]['hero_scroll_headline'] = ['Headline', 'Optional headline for this scroll step.'];
$GLOBALS['TL_LANG'][$strName]['hero_scroll_text'] = ['Text', 'Body text for this scroll step.'];
