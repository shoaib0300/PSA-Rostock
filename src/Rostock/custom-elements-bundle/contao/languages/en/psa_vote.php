...
$GLOBALS['TL_LANG']['PSA']['vote_hint_single'] = 'Click a person to select them, then submit your vote.';
$GLOBALS['TL_LANG']['PSA']['vote_hint_multi'] = 'Select one person for each position, then submit your vote.';
