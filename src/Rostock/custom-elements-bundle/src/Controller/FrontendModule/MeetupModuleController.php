...
#[AsFrontendModule(type: 'psa_meetup', category: 'PSA Rostock', template: 'mod_psa_meetup', cache: false)]
final class MeetupModuleController extends AbstractFrontendModuleController
{
